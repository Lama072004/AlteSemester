...
from pie.pieCore import PieIdentifyable
from pie.pieActuators import PieActuator
from pie.pieSensors import PieSensor
...
class PieRegulator( PieIdentifyable):
    ...
    class ActuatorU( PieActuator):
        """Hält nur den Wert, der auf die HW zu schreiben ist und die Methode (:meth:`write_to_hardware`) muss in einer Subclass implementiert werden - wenn diese Klasse Verwednung finden soll.

        Diese Klasse muss nicht unbedingt verwendet werden, es kann auch :meth:`actuatorU_new`
    ...
    class SensorW( PieSensor):
        """Hält nur den Wert, der von der HW zu lesen ist und die Methode (:meth:`read_from_hardware`) muss in einer Subclass implementiert werden - wenn diese Klasse Verwednung finden soll.

        Diese Klasse muss nicht unbedingt verwendet werden, es kann auch :meth:`sensorW_new`
        überschrieben werden, die einen Aktuator liefert.
        """
        pass
    ...
    class SensorY( PieSensor):
        ...
        Diese Klasse muss nicht unbedingt verwendet werden, es kann auch :meth:`sensorY_new`
        überschrieben werden, die einen Aktuator liefert.
        """
        pass
    ...
    def sensorW_new( self):
        ...
        Wird diese Methode nicht überschrieben, retourniert sie :class:`PieRegulator.SesnorW`, d.h.
        man hat über die Ableitung der Klasse :class:`PieRegulator.SesnorW` ebensogute Steuerungsmöglichkeiten.
        """
    ...
    def sensorY_new( self):
        ...
        man hat über die Ableitung der Klasse :class:`PieRegulator.SensorY` ebensogute Steuerungsmöglichkeiten.
        """
